package taha.demiryol.springquartzexample.service;
...
import taha.demiryol.springquartzexample.component.JobScheduleCreator;
import taha.demiryol.springquartzexample.entity.SchedulerJobInfo;
import taha.demiryol.springquartzexample.job.CronJob;
import taha.demiryol.springquartzexample.job.SimpleJob;
import taha.demiryol.springquartzexample.repository.SchedulerRepository;
            ...
            if (!scheduler.checkExists(jobDetail.getKey())) {
                ...
                if (jobInfo.getCronJob()) {
                    trigger = scheduleCreator.createCronTrigger(jobInfo.getJobName(), new Date(),
                            jobInfo.getCronExpression(), CronTrigger.MISFIRE_INSTRUCTION_SMART_POLICY);
                } else {
